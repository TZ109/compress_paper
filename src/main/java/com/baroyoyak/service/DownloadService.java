...
public class DownloadService {
	...
	public void downloadResult_hwp(String title, String body, HttpServletResponse response, File file)
	{
		BufferedOutputStream out = null;
	     InputStream in = null;
		 try {
			 //한글제목은 encoding해서 보내줘야함
			 String encordedFilename = URLEncoder.encode(title+".hwp","UTF-8").replace("+", "%20");
	...
	public void downloadResult_pdf(String title, String body, HttpServletResponse response, File file)
	{
		BufferedOutputStream out = null;
	     InputStream in = null;
		 try {
